...
- Scene discovery never calls `UObject.inheritenceChain`; dynamic H5 package classes may pass through native abstract bases whose `getConstructorName()` intentionally throws. Specialized actor deferral uses a side-effect-free JavaScript constructor/prototype walk instead.
